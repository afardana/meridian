...
Also the `executeTool` hold guard (1444-1451) and the mechanical engine (removed 2026-09-25, audit 01 §3) was `rebalanceMode` **"shadow"** by default (config.js:733) → decision points log `[REBALANCE_SHADOW]` and take the ordinary close path (index.js:1079-1090 for the round-trip roll-up).
