...
const toolMap = {
  ...
  update_config: ({ changes, reason = "" }) => {
    ...
    const CONFIG_MAP = {
      ...
      criFilterMode: ["screening", "criFilterMode"],
      criRejectThreshold: ["screening", "criRejectThreshold"],
      smartFlowMinRatio: ["screening", "smartFlowMinRatio"],
      smartExodusAlertEnabled: ["screening", "smartExodusAlertEnabled"],
      ...
      harvestStraddleBins: ["management", "harvestStraddleBins"],
...
export async function sweepWalletDust() {
  ...
  try {
    ...
    for (const t of balances.tokens) {
      ...
      // claimed-fee residue. EXCEPTION: balances the exit-swap guard explicitly
