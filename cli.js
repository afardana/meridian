...
\`\`\`
Valid keys: minTvl, maxTvl, maxPositions, deployAmountSol, managementIntervalMin, screeningIntervalMin, managementModel, screeningModel, generalModel, autoSwapAfterClaim, minClaimAmount, outOfRangeWaitMinutes (outOfRangeWaitMinutesAbove/Below too; a literal null disables OOR auto-close for that direction)
\`\`\`
